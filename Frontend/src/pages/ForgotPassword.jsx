            ...
            <>
              <div className="bg-green-50 border border-green-600/30 rounded-xl p-4 mt-5 text-center">
                ...
                <p className="text-[11px] leading-4 text-slate-600 mt-1">
                  If <span className="font-mono text-slate-800">{email}</span>{" "}
              ...
              <div className="mt-5 pt-4 border-t border-slate-200 text-center">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 min-h-[44px] px-4 text-[11px] font-semibold text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-lg transition-all cursor-pointer"
                >
              ...
              <div className="mt-5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoFocus
                    className={`w-full min-h-[48px] text-sm text-slate-800 bg-white border rounded-lg pl-10 pr-4 py-3 outline-none placeholder:text-slate-400 transition-all ${
                      error
                        ? "border-red-500"
