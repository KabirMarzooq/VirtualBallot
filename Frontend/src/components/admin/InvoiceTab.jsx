...
function InvoiceModal({ inv, branding, onClose }) {
  ...
  const handleDownload = () => {
    ...
    <style>
      ...
      .head{border-bottom:4px double #27272A;padding-bottom:20px;margin-bottom:28px;display:flex;justify-content:space-between;align-items:flex-start}
      ...
      td{padding:10px 0;font-family:Arial;font-size:14px;border-bottom:1px solid #F4F4F5}
      .label{color:#52525B}.val{text-align:right;font-weight:700;color:#18181B}
      .total td{border-top:2px solid #27272A;border-bottom:none;font-size:18px;font-weight:900;padding-top:16px}
      .footer{margin-top:32px;padding-top:16px;border-top:1px solid #E4E4E7;font-size:10px;color:#A1A1AA;font-family:monospace}
    </style></head><body><div class="page">
    <div class="head">
      <div>
        <div style="font-size:10px;letter-spacing:.2em;text-transform:uppercase;color:#52525B;font-family:Arial;margin-bottom:6px">${org}</div>
        <h1>Vote Invoice</h1>
        <div style="font-family:monospace;font-size:12px;color:#A1A1AA;margin-top:6px">${
          inv.reference
        }</div>
      </div>
      <span class="status ${
    ...
    <p style="font-size:11px;color:#52525B;font-family:Arial">The vote amount of ${naira(
      inv.amount_kobo
